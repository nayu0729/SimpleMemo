...
import { validateMemoContent, containsForbiddenContent } from '../../utils/xssSecurity'
...
const Create = (): JSX.Element => {
    ...
    const handlePress = (): void => {
        ...
        // サニタイズされた内容で保存処理（将来のFirestore保存用）
        const sanitizedContent = validation.sanitized
        console.log('保存する内容（サニタイズ済み）:', sanitizedContent)

        // TODO: Firestoreへの保存処理をここに実装
